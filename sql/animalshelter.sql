...
3	Lilly	5	Likes to chase ball around the cage and go for walks	2017-03-01	\N	t	2
\.
...
SELECT pg_catalog.setval('animal_id_seq', 8, true);
...
SELECT pg_catalog.setval('breed_id_seq', 103, true);
